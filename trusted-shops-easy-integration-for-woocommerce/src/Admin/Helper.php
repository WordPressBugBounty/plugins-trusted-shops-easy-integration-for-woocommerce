		...
		if ( self::is_settings_request() ) {
			...
			wp_localize_script(
				...
				array(
					...
					'i18n_change_credentials'          => _x( 'Are you sure you want to change your login information?', 'trusted-shops', 'trusted-shops-easy-integration-for-woocommerce' ),
					'i18n_disconnect'                  => _x( 'Disconnecting will delete all your current settings. Are you sure?', 'trusted-shops', 'trusted-shops-easy-integration-for-woocommerce' ),
					'i18n_export'                      => _x( 'Do you want to export your latest orders to a CSV file and start the download?', 'trusted-shops', 'trusted-shops-easy-integration-for-woocommerce' ),
